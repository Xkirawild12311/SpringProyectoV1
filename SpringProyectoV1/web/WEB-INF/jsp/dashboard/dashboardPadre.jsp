                ...
                <div class="ct" id="t3">
                    <div class="ct" id="t4">
                        <div class="ct" id="t5"> 
                            ...
                            <ul id="menu">                    
                                <a href="home.htm"><i class="icon fas fa-chess-king" style="font-size:60px; color:red;"></i><br>ANDINO</a>
                                <br>
                                <br>
                                <br>
                                <li><a href="#t1"><i class="icon fa fa-address-card" id="uno"></i><br>Cuenta</a></li>
                                <br>
                                <li><a href="#t2"><i class="icon fab fa-elementor" id="dos"></i><br>Cursos</a></li>
                                <br>
                                <li><a href="#t3"><i class="icon fas fa-indent" id="tres"></i><br>Notas</a></li>
                                <br>
                                <li><a href="#t4" class="center"><i class="icon fas fa-industry" id="cuatro"></i><br>Rendimiento Académico</a></li>                     
