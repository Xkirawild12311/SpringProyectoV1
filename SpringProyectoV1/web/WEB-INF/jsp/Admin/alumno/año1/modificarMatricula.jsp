         ...
         <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form:form method="post" commandName="matricula">
                        ...
                        <p>
                            <form:label path="Padre_idPadre">Id Padre</form:label>
                            <form:input path="Padre_idPadre" cssClass="form-control" />
                        </p>

                        <p>
                            <form:label path="alumno_idAlumno">Id Alumno</form:label>
                            <form:input path="alumno_idAlumno" cssClass="form-control" />
                        </p>
                  
                        <p>
                            <form:label path="nivel_idNivel">Grado</form:label>
                        ...
                        <a href="matricula1.htm?alumno_idAlumno=${alumno_idAlumno}" class="btn btn-warning">Cancelar</a>
