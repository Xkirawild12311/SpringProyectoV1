         ...
         <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form:form method="post" commandName="curso">
                        ...
                        <p>
                            <form:label path="idCurso">IdCurso</form:label>
                            <form:input path="idCurso" cssClass="form-control" />

                        </p>
                         <p>
                            <form:label path="asignatura">Nombre de la Asignatura</form:label>
                        ...
                        <a href="adminCurso.htm" class="btn btn-warning">Cancelar</a>
                    </form:form>
                        <br>
                        <br>
                </div>
